import React, { ElementType, HTMLProps, ReactElement } from 'react';
import clsx from 'clsx';
import { FadeInProps } from './FadeIn';

// interface CustomAsProp {
//   as?: ElementType;
// }

interface CustomAsProp {
  as?: React.ElementType<any> | React.ComponentType<any>;
}

type BorderProps = HTMLProps<HTMLElement> &
  CustomAsProp & {
    position?: 'top' | 'left';
    invert?: boolean;
  };
...
// type BorderProps = HTMLProps<HTMLElement> &
//   CustomAsProp & {
//     as?: string | React.FC<FadeInProps>;
//     position?: 'top' | 'left';
//     invert?: boolean;
//   };
