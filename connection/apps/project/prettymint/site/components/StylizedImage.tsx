...
interface StylizedImageProps extends HTMLAttributes<HTMLDivElement> {
  shape?: number;
  src: string | StaticImageData; // You need to include 'src' since it's required by the Next.js Image component
  alt?: string; // Optional if you don't want to specify it
  sizes?: string; // Optional if you don't want to specify it
}
