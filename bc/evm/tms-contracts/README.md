...
Create a project that uses Trust Minimized Services to build Hybrid Contract solutions while comparing Strengths and Weakness of solution providers.

## Foundry Setup

Use [updraft cyfrin](https://updraft.cyfrin.io/courses/foundry/foundry-simple-storage/foundry-setup?lesson_format=video) as reference to setting up professional configuration used by auditors.

# Motivation

Enable people to get into building ideas instead configuring build systems.

Make it easier to compare and contrast providers of blockchain infrastructure.
